...
const Home = () => {
  ...
  return (
    <>
    <div style={{color:"black", fontSize:"38px", marginTop:"75px", textAlign:"center"}}>Welcome to Fake Store<br></br> { user && user.email?.split("@")[0]}</div>
    <div style={{display:"grid", gridTemplateColumns:"1fr 1fr 1fr", justifyContent:"center", marginTop:"100px"}}>
    <div>
      <img src={Image1} style={{width:"450px", height:"600px", display:"flex"}}></img>
    </div>
     <div>
