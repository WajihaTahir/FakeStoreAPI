        ...
        <form onSubmit={handleSubmit}>
          <div className='input-control'>
            ...
            <div className='input-control'>
              ...
              <input type= {visible ? "text" : "password"}  placeholder='enter your password' value={password} onChange={(e)=>setPassword(e.target.value)} className='input-field'>               
              </input>
              <div style={{padding:"2px", color:"black"}} onClick={()=> setVisible(!visible)}>
                {visible ? <EyeOutlined/> : <EyeInvisibleOutlined/>}</div>

            </div>
            <button type='submit' name='Submit' className='input-submit' value="Sign-In">Sign In</button>
            <GoogleButton style={{marginLeft:"70px"}} onClick={handleGoogleSignIn}/>
        </form>
      </section>
    </div> 
      </>
